...
export const query = graphql`
  fragment JoinImage03 on MarkdownRemark {
    frontmatter {
      joinImage03 {
        alt
        image
...
export default class JoinImage03 extends Component {
  state = {
    loaded: false,
    isOpen: false,
    sliderImages: [],
          ...
          <div className="JoinImage">
            {images.map((image, index) => (
              <div
                ...
                tabIndex={0}
                // NOT SURE IF THIS SHOULD BE JoinImage03 OR JoinImage
