...
export const query = graphql`
  fragment ProjectImage04 on MarkdownRemark {
    frontmatter {
      projectImage04 {
        alt
        image
...
export default class ProjectImage04 extends Component {
  state = {
    loaded: false,
    isOpen: false,
    sliderImages: [],
          ...
          <div className="ProjectImage">
            {images.map((image, index) => (
              <div
                ...
                tabIndex={0}
                // NOT SURE IF THIS SHOULD BE ProjectImage04 OR ProjectImage
