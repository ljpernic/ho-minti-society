...
export const query = graphql`
  fragment JoinImage01 on MarkdownRemark {
    frontmatter {
      joinImage01 {
        alt
        image
...
export default class JoinImage01 extends Component {
  state = {
    loaded: false,
    isOpen: false,
    sliderImages: [],
          ...
          <div className="JoinImage">
            {images.map((image, index) => (
              <div
                ...
                tabIndex={0}
                // NOT SURE IF THIS SHOULD BE JoinImage01 OR JoinImage
