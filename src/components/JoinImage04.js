...
export const query = graphql`
  fragment JoinImage04 on MarkdownRemark {
    frontmatter {
      joinImage04 {
        alt
        image
...
export default class JoinImage04 extends Component {
  state = {
    loaded: false,
    isOpen: false,
    sliderImages: [],
          ...
          <div className="JoinImage">
            {images.map((image, index) => (
              <div
                ...
                tabIndex={0}
                // NOT SURE IF THIS SHOULD BE JoinImage04 OR JoinImage
